...
public interface QuizDao extends JpaRepository<Quiz, QuizId> {
	...
	public void deleteByQuizIdAndQuIdInAndPublishedFalseOrQuizIdAndQuIdInAndStartDateAfter( //
			int quizId, List<Integer> quIds, int quizId2, List<Integer> quIds2, LocalDate now);

	public List<Quiz> findByQuizIdAndQuIdInAndPublishedFalseOrQuizIdAndQuIdInAndStartDateAfter( //
			int quizId, List<Integer> quIds, int quizId2, List<Integer> quIds2, LocalDate now);
